      ...
      <div className="hero-wrapper" id="hero-wrapper">
        ...
        <div className="hero-about-me">
          <p>
            ...
            </a> this past summer, where I built out several deep learning models
            (CNN, Bert, LSTM, GRU) and an associated vector database with supported nearest-neighbor search capabilities for
            model-produced embeddings of DNA sequences.
            <br></br>
